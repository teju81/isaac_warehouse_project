...
Usage:
    ros2 run nav2_sandbox joy_teleop.py                          # defaults to /g1/cmd_vel
    ros2 run nav2_sandbox joy_teleop.py --topic /explorer/cmd_vel
    ros2 run nav2_sandbox joy_teleop.py --topic /drone/cmd_vel --linear-axis 3 --angular-axis 2
"""
import argparse
import rclpy
...
def main():
    ...
    parser.add_argument("--deadzone", type=float, default=0.15, help="Axis deadzone")
